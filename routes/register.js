...
router.post('/', urlencodedParser, function (req, res, next) {
    ...
    user.PROFILE_IMG_URL = 'https://u.ironman.com/sites/default/files/useravatar_1406.jpeg';
    user.COVER_PHOTO_URL = 'http://fox-grove.com/wp-content/uploads/2014/12/black-polygon-with-red-edges-abstract-hd-wallpaper-1920x1080.jpg';
    user.friends = [];
